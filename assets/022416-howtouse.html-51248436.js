...
## pnpm
pnpm sidebar
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="最后" tabindex="-1"><a class="header-anchor" href="#最后" aria-hidden="true">#</a> 最后</h2><p>为了更加愉快的书写 文档 和 博客，推荐使用 <code>Typora</code>~</p>`,12);function j(w,E){const e=c("ExternalLinkIcon");return o(),l("div",null,[r,n("p",null,[s("欢迎入驻爱尔前端文档博客~ 这个博客是采用 "),n("a",d,[u,a(e)]),s("创建，整个渲染是基于 "),v,s(" 的， 同时，我们集成了最流行的 "),m,s(" 主题 "),n("a",k,[b,a(e)]),s("。")]),h,n("ul",null,[g,n("li",null,[s("博客的头部文件请注意正确书写 "),_,s("，很多的 "),x,s("名称和方式，请"),n("a",f,[s("参考官方文档"),a(e)]),s("。")]),y]),q])}const V=i(p,[["render",j],["__file","022416-howtouse.html.vue"]]);export{V as default};
