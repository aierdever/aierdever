import{_ as d,p as r,q as p,s as n,G as s,t as e,P as l,J as i,n as c}from"./framework-d4dfb5a8.js";const u={},v=n("div",{class:"custom-container info"},[n("svg",{xmlns:"http://www.w3.org/2000/svg","xmlns:xlink":"http://www.w3.org/1999/xlink",viewBox:"0 0 24 24"},[n("g",{fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round"},[n("circle",{cx:"12",cy:"12",r:"9"}),n("path",{d:"M12 8h.01"}),n("path",{d:"M11 12h1v4h1"})])]),n("p",{class:"custom-container-title"},"引子"),n("p",null,[n("strong",null,"隙中驹，石中火"),s(" , 时间如白驹飞驰，击石一闪即灭的火花，而智慧的火花闪亮间照亮了生命的原野。")]),n("p",null,[s("欢迎入驻爱尔前端文档博客——石火之间，"),n("strong",null,"愿你在这儿留下思考的脚印，体验的圣典"),s(" ~")])],-1),m=n("h2",{id:"欢迎使用",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#欢迎使用","aria-hidden":"true"},"#"),s(" 欢迎使用")],-1),b={href:"https://v2.vuepress.vuejs.org/zh/",target:"_blank",rel:"noopener noreferrer"},h=n("code",null,"vuepress 2.0",-1),k=n("code",null,"vue3 + vite",-1),g=n("code",null,"vuepress",-1),_={href:"http://v2.vuepress-reco.recoluan.com/",target:"_blank",rel:"noopener noreferrer"},x=n("code",null,"vuepress-theme-reco",-1),f=i(`<p>需要说明的是，这个主题 集合了 <strong>博客</strong> 和 <strong>文档</strong> 两个功能。 书写博客或文档都是采用最流行的<code>markdown</code>格式。</p><p><strong>注：</strong> 为了便于生成导航，文档请使用 <strong>.md</strong> 做文件后缀名。</p><h2 id="目录" tabindex="-1"><a class="header-anchor" href="#目录" aria-hidden="true">#</a> 目录</h2><p>书写博客请放置在 <code>blogs</code> 文件夹中，文档请在 <code>docs</code> 目录下根据文档类型，建立目录书写存放。</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code>aierdever
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="静态资源存放目录" tabindex="-1"><a class="header-anchor" href="#静态资源存放目录" aria-hidden="true">#</a> 静态资源存放目录</h2><p>书写博文时，我们经常会有图片或资源需要存放， 为了便于维护和查找，请将资源存放在 <code>/.vuepress/pubilc/</code> 中(如上目录结构，已分类)， 博客请在目录中新建文件夹，分类存放。 如：文档 pcwork 的资源我们就放置在 <code>/.vuepress/pubilc/docs/pcwork</code></p><h2 id="图标使用" tabindex="-1"><a class="header-anchor" href="#图标使用" aria-hidden="true">#</a> 图标使用</h2>`,8),w={href:"https://www.xicons.org/#/zh-CN",target:"_blank",rel:"noopener noreferrer"},q=n("strong",null,[n("code",null,"carbon"),s(" 1 种图标")],-1),y=i(`<div class="language-vue line-numbers-mode" data-ext="vue"><pre class="language-vue"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>xicons</span> <span class="token attr-name">icon</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>Star<span class="token punctuation">&quot;</span></span> <span class="token punctuation">/&gt;</span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="博客书写规范" tabindex="-1"><a class="header-anchor" href="#博客书写规范" aria-hidden="true">#</a> 博客书写规范</h2>`,2),j=n("li",null,[s("博客请放置在"),n("code",null,"blogs"),s("里对应年份的文件夹中，文件名为 "),n("code",null,"月日时-内容标题.md"),s("，如： "),n("code",null,"020418-howtouse.md"),s("，这样博客系统会自动帮收入博客列表中，")],-1),z=n("code",null,"Frontmatter",-1),C=n("code",null,"Frontmatter",-1),E={href:"https://v2.vuepress.vuejs.org/zh/reference/frontmatter.html",target:"_blank",rel:"noopener noreferrer"},S=n("li",null,[s("注意写好 "),n("code",null,"tags"),s(" 和 "),n("code",null,"categories"),s("，多个字段分组书写，博客会自动根据这些字段自动分类文章。")],-1),B=i(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>---
title: 想知道怎么使用这个博客吗？
...
<span class="token punctuation">]</span>
    ...
    :::
::::
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,12),F={href:"https://www.xicons.org/#/zh-CN",target:"_blank",rel:"noopener noreferrer"},N=n("strong",null,[n("code",null,"carbon"),s(" 图标")],-1),M=i(`<p><strong>示例代码：</strong></p><div class="language-markdown line-numbers-mode" data-ext="md"><pre class="language-markdown"><code>:::: nav-group pc框架手册
    ::: nav Home
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="最后" tabindex="-1"><a class="header-anchor" href="#最后" aria-hidden="true">#</a> 最后</h2><p>为了更加愉快的书写 文档 和 博客，推荐使用 <code>Typora</code>~</p>`,5);function X(I,J){const a=c("ExternalLinkIcon"),o=c("xicons"),t=c("RouterLink");return r(),p("div",null,[v,m,n("p",null,[s("石火之间博客 是采用 "),n("a",b,[h,e(a)]),s("创建，整个渲染是基于 "),k,s(" 的， 同时，我们集成了最流行的 "),g,s(" 主题 "),n("a",_,[x,e(a)]),s("。")]),f,n("p",null,[s("vuepress-theme-reco@2.x 是通过 Xicons 来配置图标的，"),n("a",w,[s("Xicons"),e(a)]),s(" 只集成了 "),q,s("，几乎可以满足绝大部分场景。 如果想要在 markdown 中输出一个星星图标 "),e(o,{icon:"Star"}),s("，你就可以在 markdown 中这样编辑代码：")]),y,n("ul",null,[j,n("li",null,[s("博客的头部文件请注意正确书写 "),z,s("，很多的 "),C,s("名称和方式，请"),n("a",E,[s("参考官方文档"),e(a)]),s("。")]),S]),B,n("p",null,[s("图标从 "),n("a",F,[s("Xicons"),e(a)]),s(" 的 "),N,s(" 中查找，设置 icon名称即可。")]),M,n("div",D,[L,n("div",V,[e(o,{class:"xicon",iconSize:"28",icon:"Home"}),n("p",null,[e(t,{to:"/docs/pcwork/index/"},{default:l(()=>[s("首页")]),_:1})])]),n("div",H,[e(o,{class:"xicon",iconSize:"28",icon:"Book"}),n("p",null,[e(t,{to:"/docs/pcwork/1.base/1.files.html"},{default:l(()=>[s("框架基础")]),_:1})])]),n("div",P,[e(o,{class:"xicon",iconSize:"28",icon:"Carbon3DPrintMesh"}),n("p",null,[e(t,{to:"/docs/pcwork/2.css/1.grid.html"},{default:l(()=>[s("样式及图标")]),_:1})])])]),R])}const A=d(u,[["render",X],["__file","022416-howtouse.html.vue"]]);export{A as default};
