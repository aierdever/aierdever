...
<span class="token punctuation">]</span>
    ...
    :::
::::
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,12),R={href:"https://www.xicons.org/#/zh-CN",target:"_blank",rel:"noopener noreferrer"},X=n("strong",null,[n("code",null,"carbon"),s(" 图标")],-1),A=i(`<p><strong>示例代码：</strong></p><div class="language-markdown line-numbers-mode" data-ext="md"><pre class="language-markdown"><code>:::: nav-group pc框架手册
    ::: nav Home
