...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="博客书写规范" tabindex="-1"><a class="header-anchor" href="#博客书写规范" aria-hidden="true">#</a> 博客书写规范</h2>`,2),y=n("li",null,[s("博客请放置在"),n("code",null,"blogs"),s("里对应年份的文件夹中，文件名为 "),n("code",null,"月日时-内容标题.md"),s("，如： "),n("code",null,"020418-howtouse.md"),s("，这样博客系统会自动帮收入博客列表中，")],-1),j=n("code",null,"Frontmatter",-1),C=n("code",null,"Frontmatter",-1),E={href:"https://v2.vuepress.vuejs.org/zh/reference/frontmatter.html",target:"_blank",rel:"noopener noreferrer"},F=n("li",null,[s("注意写好 "),n("code",null,"tags"),s(" 和 "),n("code",null,"categories"),s("，多个字段分组书写，博客会自动根据这些字段自动分类文章。")],-1),z=i(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>---
title: 想知道怎么使用这个博客吗？
...
<span class="token punctuation">]</span>
    ...
    :::
::::
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,12),B={href:"https://www.xicons.org/#/zh-CN",target:"_blank",rel:"noopener noreferrer"},S=n("strong",null,[n("code",null,"carbon"),s(" 图标")],-1),N=i(`<p><strong>示例代码：</strong></p><div class="language-markdown line-numbers-mode" data-ext="md"><pre class="language-markdown"><code>:::: nav-group pc框架手册
    ::: nav Home
