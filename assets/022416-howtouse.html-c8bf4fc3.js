...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="静态资源存放目录" tabindex="-1"><a class="header-anchor" href="#静态资源存放目录" aria-hidden="true">#</a> 静态资源存放目录</h2><p>书写博文时，我们经常会有图片或资源需要存放， 为了便于维护和查找，请将资源存放在 <code>/.vuepress/pubilc/</code> 中(如上目录结构，已分类)， 博客请在目录中新建文件夹，分类存放。 如：文档 pcwork 的资源我们就放置在 <code>/.vuepress/pubilc/docs/pcwork</code></p><h2 id="图标使用" tabindex="-1"><a class="header-anchor" href="#图标使用" aria-hidden="true">#</a> 图标使用</h2>`,6),S={href:"https://www.xicons.org/#/zh-CN",target:"_blank",rel:"noopener noreferrer"},N=n("strong",null,[n("code",null,"carbon"),s(" 1 种图标")],-1),D=i(`<div class="language-vue line-numbers-mode" data-ext="vue"><pre class="language-vue"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>xicons</span> <span class="token attr-name">icon</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>Star<span class="token punctuation">&quot;</span></span> <span class="token punctuation">/&gt;</span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="博客书写规范" tabindex="-1"><a class="header-anchor" href="#博客书写规范" aria-hidden="true">#</a> 博客书写规范</h2>`,2),L=n("li",null,[s("博客请放置在"),n("code",null,"blogs"),s("里对应年份的文件夹中，文件名为 "),n("code",null,"月日时-内容标题.md"),s("，如： "),n("code",null,"020418-howtouse.md"),s("，这样博客系统会自动帮收入博客列表中，")],-1),V=n("code",null,"Frontmatter",-1),F=n("code",null,"Frontmatter",-1),H={href:"https://v2.vuepress.vuejs.org/zh/reference/frontmatter.html",target:"_blank",rel:"noopener noreferrer"},M=n("li",null,[s("注意写好 "),n("code",null,"tags"),s(" 和 "),n("code",null,"categories"),s("，多个字段分组书写，博客会自动根据这些字段自动分类文章。")],-1),P=i(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>---
title: 想知道怎么使用这个博客吗？
