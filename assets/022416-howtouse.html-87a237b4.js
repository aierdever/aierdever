...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="博客书写规范" tabindex="-1"><a class="header-anchor" href="#博客书写规范" aria-hidden="true">#</a> 博客书写规范</h2>`,2),y=n("li",null,[s("博客请放置在"),n("code",null,"blogs"),s("里对应年份的文件夹中，文件名为 "),n("code",null,"月日时-内容标题.md"),s("，如： "),n("code",null,"020418-howtouse.md"),s("，这样博客系统会自动帮收入博客列表中，")],-1),j=n("code",null,"Frontmatter",-1),E=n("code",null,"Frontmatter",-1),z={href:"https://v2.vuepress.vuejs.org/zh/reference/frontmatter.html",target:"_blank",rel:"noopener noreferrer"},F=n("li",null,[s("注意写好 "),n("code",null,"tags"),s(" 和 "),n("code",null,"categories"),s("，多个字段分组书写，博客会自动根据这些字段自动分类文章。")],-1),S=i(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>---
title: 想知道怎么使用这个博客吗？
...
<span class="token punctuation">]</span>
    ...
    :::
::::
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,12),C={href:"https://www.xicons.org/#/zh-CN",target:"_blank",rel:"noopener noreferrer"},N=n("strong",null,[n("code",null,"carbon"),s(" 图标")],-1),B=i(`<p><strong>示例代码：</strong></p><div class="language-markdown line-numbers-mode" data-ext="md"><pre class="language-markdown"><code>:::: nav-group pc框架手册
    ::: nav Home
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="最后" tabindex="-1"><a class="header-anchor" href="#最后" aria-hidden="true">#</a> 最后</h2><p>为了更加愉快的书写 文档 和 博客，推荐使用 <code>Typora</code>~</p>`,5);function R(X,A){const a=l("ExternalLinkIcon"),o=l("xicons"),c=l("RouterLink");return r(),p("div",null,[v,n("p",null,[s("欢迎入驻爱尔前端文档博客~ 这个博客是采用 "),n("a",m,[b,e(a)]),s("创建，整个渲染是基于 "),h,s(" 的， 同时，我们集成了最流行的 "),k,s(" 主题 "),n("a",g,[_,e(a)]),s("。")]),x,n("p",null,[s("vuepress-theme-reco@2.x 是通过 Xicons 来配置图标的，"),n("a",f,[s("Xicons"),e(a)]),s(" 只集成了 "),w,s("，几乎可以满足绝大部分场景。 如果想要在 markdown 中输出一个星星图标 "),e(o,{icon:"Star"}),s("，你就可以在 markdown 中这样编辑代码：")]),q,n("ul",null,[y,n("li",null,[s("博客的头部文件请注意正确书写 "),j,s("，很多的 "),E,s("名称和方式，请"),n("a",z,[s("参考官方文档"),e(a)]),s("。")]),F]),S,n("p",null,[s("图标从 "),n("a",C,[s("Xicons"),e(a)]),s(" 的 "),N,s(" 中查找，设置 icon名称即可。")]),B,n("div",D,[L,n("div",V,[e(o,{class:"xicon",iconSize:"28",icon:"Home"}),n("p",null,[e(c,{to:"/docs/pcwork/index/"},{default:t(()=>[s("首页")]),_:1})])]),n("div",H,[e(o,{class:"xicon",iconSize:"28",icon:"Book"}),n("p",null,[e(c,{to:"/docs/pcwork/1.base/1.files.html"},{default:t(()=>[s("框架基础")]),_:1})])]),n("div",M,[e(o,{class:"xicon",iconSize:"28",icon:"Carbon3DPrintMesh"}),n("p",null,[e(c,{to:"/docs/pcwork/2.css/1.grid.html"},{default:t(()=>[s("样式及图标")]),_:1})])])]),P])}const J=d(u,[["render",R],["__file","022416-howtouse.html.vue"]]);export{J as default};
